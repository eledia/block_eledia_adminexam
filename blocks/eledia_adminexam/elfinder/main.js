...
(function(){
	...
	var // jQuery and jQueryUI version
		...
		start = function(elFinder, editors, config) {
			// load jQueryUI CSS
			elFinder.prototype.loadCss('js/jquery/jqueryui/1.12.1/themes/smoothness/jquery-ui.css');
	...
	require.config({
		baseUrl : 'js',
		paths : {
			'jquery'   : 'jquery/jquery/3.6.0/jquery-3.6.0.min',
			'jquery-ui': 'jquery/jqueryui/1.12.1/jquery-ui.min',
			'elfinder' : 'elfinder.min',
			'encoding-japanese': 'extras/encoding-japanese/encoding.min'
		},
